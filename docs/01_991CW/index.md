...
![fx-991CW](../../assets/images/01_991CW/01_start.jpg "fx-991CW")
...
![fx-991CW on Amazon.in](../../assets/images/01_991CW/02_amazon_in.png "fx-991CW on Amazon.in")
...
![包装正面](../../assets/images/01_991CW/03_pack.jpg "包装正面")

印度尼西亚作为非英语为官方语言的国家，从印尼境内购买的卡西欧计算器其包装背面贴上了印尼语的对于授权进口经销商和产品的相关说明。
（KARTU GARANSI=保修卡；GARANSI TAHUN=保修一年）

![包装背面](../../assets/images/01_991CW/04_pack_back.jpg "包装背面")

下图所示为fx-991ID PLUS的包装盒，可以看到其外包装背面也贴上了印尼语的对于授权进口经销商和产品的相关说明。

![fx-991ID PLUS包装盒](../../assets/images/01_991CW/04_pack_back_idplus.jpg "fx-991ID PLUS包装盒")

可以看到fx-991CW的包装跟fx-880BTG一样非常薄（就计算器+两张纸的厚度）。

![包装侧面](../../assets/images/01_991CW/05_pack_side.jpg "包装侧面")

打开包装后一共有图示的几样物品。

跟fx-880BTG一样，fx-991CW本体外只套有一个塑料薄膜袋，总之我对运输过程中的能否防止摩擦或损坏保持怀疑。

![全部物品](../../assets/images/01_991CW/06_all_items.jpg "全部物品")
...
![正面](../../assets/images/01_991CW/07_front.jpg "正面")
...
![背面](../../assets/images/01_991CW/08_back.jpg "背面")

### 入门说明(Startup Guide)

入门说明已将纸质说明书替代，完整的纸质说明书已经不提供，用户需要扫描入门说明上的二维码以下载PDF文件或浏览网页版来阅读完整说明书。

![入门说明(Startup Guide)](../../assets/images/01_991CW/09_startup.jpg "入门说明(Startup Guide)")
...
![计算器使用指南(Pedoman Pemakaian Kalkulator)](../../assets/images/01_991CW/10_idstartup.jpg "计算器使用指南(Pedoman Pemakaian Kalkulator)")
...
![按键/印刷](../../assets/images/01_991CW/12_button.jpg "按键/印刷")
...
![拆机](../../assets/images/01_991CW/13_inside_1.jpg "拆机")

两者对比不难看出：屏幕塑料背板为有太阳能板的电源线路和无太阳能板的电源线路都设计了不同的卡扣。

![屏幕塑料背板卡扣](../../assets/images/01_991CW/14_inside_2.jpg "屏幕塑料背板卡扣")

如图，一个不好的消息已经展现出了：图中电池正极（红色）的导线偏短，无法放到屏幕侧边，这意味着屏幕无法完全翻转过来。若要将屏幕翻过来，唯一的方法是将导线拆下。

![导线](../../assets/images/01_991CW/15_inside_3.jpg "导线")
...
![框自检界面](../../assets/images/01_991CW/16_test_0.jpg "框自检界面")

![第一自检](../../assets/images/01_991CW/17_test_1.jpg "第一自检")

按下`[AC]`，出现此台机器的序列号。

![序列号](../../assets/images/01_991CW/18_test_id.jpg "序列号")

按下`[CATALOG]` `[AC]`+`[ON]`后接着按`[8]`即可进入第二自检，显示的按键说明由于键位的改变有所变化。

![第二自检_1](../../assets/images/01_991CW/19_2ndtest_1.jpg "第二自检_1")

![第二自检_2](../../assets/images/01_991CW/20_2ndtest_2.jpg "第二自检_2")

![第二自检_3](../../assets/images/01_991CW/21_2ndtest_3.jpg "第二自检_3")

按下`[CATALOG]` `[AC]`+`[ON]`后接着按`[6]`即可进入第三自检。

![第三自检](../../assets/images/01_991CW/21_3ndtest.jpg "第三自检")

## “四按一松”

CW系列“四按一松”的变化在[fx-880BTG的评测](https://tieba.baidu.com/p/8088620034)中已经有详细说明。

![“四按一松”](../../assets/images/01_991CW/22_1_kiko.jpg "“四按一松”")
...
![开始（Get Started）](../../assets/images/01_991CW/22_2_getstarted.jpg "开始（Get Started）")

## 功能区别

fx-991CW的总应用数跟fx-880BTG一致，为13个应用，从图标可以看出屏幕支持灰度显示。由于应用相关的具体内容在fx-880BTG中已经有详细说明，这里仅介绍些两者有区别的地方。

![应用区别](../../assets/images/01_991CW/23_differ_app.jpg "应用区别")

正如前文所提到的，fx-991CW跟fx-991EX一样不具备PreAns功能。

![PreAns功能](../../assets/images/01_991CW/24_differ_preans.jpg "PreAns功能")
...
![二级字符表](../../assets/images/01_991CW/37_abnormal_4.png "二级字符表")
...
![Đúng乱码](../../assets/images/01_991CW/38_abnormal_5.png "Đúng乱码")

注：执行(▸Execute)按钮即为下图所示按钮。

![执行(▸Execute)按钮](../../assets/images/01_991CW/39_execute.jpg "执行(▸Execute)按钮")
...
![Fin.](../../assets/images/01_991CW/99_end.jpg "Boost your Curiosity")
