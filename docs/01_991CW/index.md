...
![fx-991CW](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/01_start.jpg "fx-991CW")
...
![fx-991CW on Amazon.in](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/02_amazon_in.png "fx-991CW on Amazon.in")
...
![包装正面](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/03_pack.jpg "包装正面")
...
![全部物品](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/06_all_items.jpg "全部物品")

### 正面
fx-991CW具有太阳能的功能。

fx-991CW的按键排布跟fx-880BTG基本一致，虽说CW系列将大部分功能塞进了菜单内，但从按键印刷上还是能稍微看出点功能差异的，显然fx-991CW跟fx-991EX一样不具备PreAns功能。
![正面](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/07_front.jpg "正面")

### 背面
目前新生产的卡西欧计算器除了国内大陆型号外其他型号基本均为泰产。

可以看到右上角给电池专门开槽预留了换电池的孔位。
![背面](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/08_back.jpg "背面")

### 入门说明(Startup Guide)
入门说明已将纸质说明书替代，完整的纸质说明书已经不提供，用户需要扫描入门说明上的二维码以下载PDF文件或浏览网页版来阅读完整说明书。
![入门说明(Startup Guide)](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/09_startup.jpg "入门说明(Startup Guide)")
...
![计算器使用指南(Pedoman Pemakaian Kalkulator)](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/10_idstartup.jpg "计算器使用指南(Pedoman Pemakaian Kalkulator)")

### 保护盖
CW系列采用了全新的卡扣式保护盖而非滑动式保护壳，材质为塑料，具体内容在fx-880BTG中已经有详细说明。

由于CW系列的计算器本体上方插槽和对应保护盖的卡扣宽度比下方的插槽卡扣要宽，因此保护盖无法上下颠倒后盖上（fx-880BTG由于电池仓凸起更加无法反向盖上）。
![保护盖](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/11_cover.jpg "保护盖")
...
![按键/印刷](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/12_button.jpg "按键/印刷")
...
![拆机](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/13_inside_1.jpg "拆机")

两者对比不难看出：屏幕塑料背板为有太阳能板的电源线路和无太阳能板的电源线路都设计了不同的卡扣。
![屏幕塑料背板卡扣](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/14_inside_2.jpg "屏幕塑料背板卡扣")

如图，一个不好的消息已经展现出了：图中电池正极（红色）的导线偏短，无法放到屏幕侧边，这意味着屏幕无法完全翻转过来。若要将屏幕翻过来，唯一的方法是将导线拆下。
![导线](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/15_inside_3.jpg "导线")

## 自检
第一第二第三自检在CW系列中都存在，在fx-880BTG的评测中已经有详细说明。

按下`[CATALOG]` `[AC]`+`[ON]`后接着按`[9]`即可进入第一自检，在最后一个屏幕测试结束后按`[5]`会出现类似ES PLUS的框自检界面。
![框自检界面](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/16_test_0.jpg "框自检界面")
![第一自检](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/17_test_1.jpg "第一自检")

按下`[AC]`，出现此台机器的序列号。
![序列号](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/18_test_id.jpg "序列号")
...
![“四按一松”](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/22_1_kiko.jpg "“四按一松”")
...
![开始（Get Started）](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/22_2_getstarted.jpg "开始（Get Started）")

## 功能区别
fx-991CW的总应用数跟fx-880BTG一致，为13个应用，从图标可以看出屏幕支持灰度显示。由于应用相关的具体内容在fx-880BTG中已经有详细说明，这里仅介绍些两者有区别的地方。
![应用区别](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/23_differ_app.jpg "应用区别")

正如前文所提到的，fx-991CW跟fx-991EX一样不具备PreAns功能。
![PreAns功能](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/24_differ_preans.jpg "PreAns功能")

进入SETTINGS（设置）-System Settings（系统设置），可以看到fx-991CW和fx-991EX一样拥有多行字体(MultiLine Font)的设置菜单，但是fx-880BTG和它的前作fx-580VN X一样，不具备此设置项，原因后文会提到。
（Sáng/tối Màn Hình=对比度；Tự động tắt=自动关机；Ngôn ngữ=语言）
![多行字体](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/25_differ_multi.jpg "多行字体")

进入[CATALOG]菜单，可以看到fx-991CW跟fx-991EX一样，并不具备大π（累乘）、÷R、GCD、LCM、循环节、Int、Intg函数功能，fx-991CW并不具备周期表和原子质量的功能。（我也不知道fx-880BTG为啥会具备）

（Số dư=求余）
![大π（累乘）](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/26_differ_sum.jpg "大π（累乘）")

（Ước chug lớn nhất=最大公约数(GCD)；Bội chung nhỏ nhất=最小公倍数(LCM)；Giá trị tuyệt đối=绝对值；Số thập phân tuần hoàn=循环小数）
![GCD&LCM](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/27_differ_gcdlcm.jpg "GCD&LCM")

（Phần Nguyên=Int；Làm Tròn=四舍五入(Rnd)；Số nguyên Lớn Nhất=Intg)
![Int&Intg](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/28_differ_intintg.jpg "Int&Intg")

(Hằng số Khoa học=科学常数；Chuyển đổi Đơn Vị=单位转换；Bảng Nguyên tử=元素周期表；Khác=其他）
![元素周期表](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/29_differ_atomic.jpg "元素周期表")
...
![循环节格式](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/30_differ_format.jpg "循环节格式")

按下`[TOOLS]`，可以很清楚的看到fx-991CW不具备CALC和验证(Verify)模式。

（Hoàn tác=撤销；Kiểm chứng Bật=验证(Verify)）
![[TOOLS]](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/31_differ_tools.jpg "[TOOLS]")

Matrix（矩阵）模式中fx-991CW和fx-880BTG均不具备Ref和Rref函数功能。（从已知消息可知fx-991DE CW和fx-991SP CW等其他部分机型具备Ref和Rref函数功能）
![Matrix（矩阵）](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/32_differ_matrix.jpg "Matrix（矩阵）")

进入Math Box，可以看到fx-991CW并没有Number Line（数轴）和Circle（圆）功能。
![Math Box](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/33_differ_mathbox.jpg "Math Box")
...
![x=AAcm▸in的BUG_1](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/34_abnormal_1.jpg "x=AAcm▸in的BUG_1")
![x=AAcm▸in的BUG_2](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/35_abnormal_2.jpg "x=AAcm▸in的BUG_2")
...
![内存对比](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/36_abnormal_3.png "内存对比")

由于同为ClassWiz系列，CW系列和X（第一代）系列相比，字符表没有大的变化，比较明显的区别是去除了M变量，其余变量全部向前移动一位（如变量A在X（第一代）系列上是`0x42`，在CW系列上是`0x41`），这也恰好符合了ASCII编码中的大写字母编码（X系列大写拼字跟用凯撒密码似的）。然而FB区的`→M`、`→A`等字符并没有删除，`→A`等甚至能正常使用。同时原先的冒号、等号等编程工具在计算模式同样能使用（但等号赋值功能被去除）。
...
![二级字符表](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/37_abnormal_4.png "二级字符表")
...
![Đúng乱码](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/38_abnormal_5.png "Đúng乱码")

注：执行(▸Execute)按钮即为下图所示按钮。
![执行(▸Execute)按钮](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/39_execute.jpg "执行(▸Execute)按钮")
...
![Fin.](https://zwolken.github.io/Calc_Review/assets/images/01_991CW/99_end.jpg "Boost your Curiosity")
